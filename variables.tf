...
variable "instance_tenancy" {
  description = "The allowed tenancy of instances launched into the selected VPC. Acceptable values default or dedicated or host"
  type        = string
}
...
variable "security_group_egress_rules" {
  description = "A map of security group ingress rule defintions to add to the security group created"
  type        = map(any)
  default     = {}
}
